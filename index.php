						...
						<div class="container">
							<div class="row">
								<div class="col-md-4">
									...
									<p><a class="btn btn-secondary" href="https://github.com/LouisOuellet/lsp" role="button"><i class="fab fa-github mr-2">GitHub<i class="fas fa-chevron-right ml-2"></i></a></p>
								</div>
								<div class="col-md-4">
