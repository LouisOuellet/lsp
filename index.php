					...
					default:?>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-4">
									<h2>Get Started</h2>
									<p class="text-justify">To get started, you need to create your first application and generate some key(s). Then you will need to add the LSP class to your application as described on github.</p>
								</div>
								<div class="col-md-4">
