						...
						<div class="container">
							<div class="row">
								<div class="col-md-4">
									...
									<h2 class="text-center border-bottom mb-3 pb-2">Get Started</h2>
								...
								<div class="col-md-4">
									...
									<h2 class="text-center border-bottom mb-5">License Services</h2>
								...
								<div class="col-md-4">
									...
									<h2 class="text-center border-bottom mb-3 pb-3">Update Services</h2>
